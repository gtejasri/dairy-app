...
const getAllDealersService = () => {
    ...
    return axios.get(`http://localhost:8086/dealer/all`);
}
const deleteDealerService = (dealerId) => {
    console.log(`deleteDealer`);
    return axios.post(`http://localhost:8086/dealer/delete/{ dealerId}/${dealerId}`);
}
const updateDealerService = (dealer) => {
    console.log(`Service updateDealer`);
    return axios.post(`http://localhost:8086/dealer/update`, dealer);
}
const insertDealerService = (dealer) => {
    console.log(`addDealer`);
    return axios.post(`http://localhost:8086/dealer/add`, dealer);
}
const getDealerService = (dealerId) => {
    console.log(`getDealerId`);
    return axios.get(`http://localhost:8086/dealer/get/${dealerId}`);
}
